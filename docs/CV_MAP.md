...
- Julia MPS / ITensors workflow:
  - `julia_kraus_oqs/src/KrausSimulation.jl`
  - `julia_kraus_oqs/src/Kraus_protocol.jl`
...
- Kraus-operator generalized measurement:
  - `julia_kraus_oqs/src/Kraus_list.jl`
  - `julia_kraus_oqs/src/Kraus_protocol.jl`
...
- Entanglement entropy:
  - `python_workflows/core/entropy.py`
  - `julia_kraus_oqs/src/Kraus_entropy.jl`
  - `julia_kraus_oqs/src/Kraus_protocol.jl`
- Stochastic Kraus decoherence trajectories:
  - `julia_kraus_oqs/src/Kraus_list.jl`
  - `julia_kraus_oqs/src/Operating_Kraus.jl`
  - `julia_kraus_oqs/src/Kraus_protocol.jl`
